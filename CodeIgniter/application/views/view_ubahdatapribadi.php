                ...
                <div class="accordion-inner">
                    <div class="span6">
						...
						<div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="input-xlarge" rows="4" id="inputKuliah" name="inputKuliah"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="span6">
                        ...
                        <div class="control-group">
							...
							<div class="controls">
                                <div class="input-prepend">
                                    <span class="add-on">+62</span>
                                    <input class="input-large" class="span2" id="inputKontakOrtu" name="inputKontakOrtu" type="text" value="" placeholder="81234....." required>                                    
                                </div>
                            </div>
